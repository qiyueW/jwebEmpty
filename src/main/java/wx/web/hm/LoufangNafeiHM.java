...
@H("/service/loufangnafei")
public class LoufangNafeiHM {

    JWeb jw;

    public LoufangNafeiHM(JWeb jw) {
        this.jw = jw;
    }
//===================添加操作=============================    
...
//===================修改操作=============================    
    @system.web.power.ann.SQ("loufangnafeiU")
    @M("/update")
    @Validate(wx.web.validate.LoufangNafeiValidate.class)
	public void update() {
		LoufangNafei obj = jw.getObject(LoufangNafei.class);
...
//===================查询操作=============================
    ...
    @system.web.power.ann.SQ("loufangnafeiS") 
...
//---------------------------------------单据状态管理---------------------------------------
    @system.web.power.ann.SQ("loufangnafeiE")
    ...
    @system.web.power.ann.SQ("loufangnafeiUE")
    ...
    @system.web.power.ann.SQ("loufangnafeiV")
    @M("/update/void")//作废
    public void tovoid() {
        String ids = jw.getString("ids");
        if (LoufangNafeiService.isErrorGelibiaoshiVast(ids, Gelibiaoshi.getGelibiaoshi(jw))) {//存在别人家的隔离标识的单据
    ...
    @system.web.power.ann.SQ("loufangnafeiUV")
    @M("/update/unvoid")//反作废
