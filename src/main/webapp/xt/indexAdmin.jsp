...
<body class="easyui-layout" style="margin: 0;">
	...
	<div data-options="region:'south',split:true"
		...
		<div style="margin-top: 4px;">
			...
			<a href="javascript:void(0)" onclick="$('#div_udpatepassword').dialog('open')">修改密码</a> &nbsp;&nbsp;&nbsp; <a
				href="${path_home}/xt/loginmanager/out/admin.jw">退出登陆</a>
		</div>
	</div>
	...
	<div id="div_udpatepassword"class="easyui-dialog" style="width: 600px; height: 300px"
	...
	<div id="tool_udpatepassword">
		<a href="javascript:void(0)" id="bt_updatepassword"
			...
			href="javascript:void(0)" class="easyui-linkbutton" onclick="$('#div_udpatepassword').dialog('close')" >关闭</a>
	</div>
</body>
</html>
