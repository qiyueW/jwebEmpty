...
<body class="easyui-layout">
	<div data-options="region:'center'" id='centerMain'>
		<input type="hidden" id="xt_guanliyuan_zj" name="xt_guanliyuan_zj"
			value="${XtGuanliyuan.xt_guanliyuan_zj}"> <input
			type="hidden" id="xt_guanliyuan_zt" name="xt_guanliyuan_zt"
			value="${XtGuanliyuan.xt_guanliyuan_zt}"> <input
			type="hidden" id="xt_guanliyuan_gelibiaoshi"
			value="${XtGuanliyuan.xt_guanliyuan_gelibiaoshi}" />
		<div class="container" id="XtGuanliyuanFormID">
			<p style="visibility: hidden;">
				<input type="text" value="admin"
					style="position: absolute; z-index: -1;" disabled
					autocomplete="off" /> <input type="password" value=" "
					style="position: absolute; z-index: -1;" disabled
					autocomplete="off" />
			</p>
			<div class="row-fluid">
				<div class="span12">
					<a href="javascript:void(0)" class="btn btn-default btn-large"
						...
						onclick="submitForm('XtGuanliyuanFormID')">保存修改</a> <a
						href="javascript:void(0)" class="btn btn-default btn-large"
			...
			<div class="row-fluid">
				<div class="span12">
					<span class="myname">管理员备注</span> <input type="text"
						value="${XtGuanliyuan.xt_guanliyuan_bz}" id="xt_guanliyuan_bz"
						name="xt_guanliyuan_bz" data-options="required:false"
						class="easyui-textbox" />
				</div>
			</div>
		</div>
