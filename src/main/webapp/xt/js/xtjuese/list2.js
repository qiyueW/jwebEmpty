...
function dellRow() {
    ...
    easyuiAjax("/xt/xtjuese2/remove.jw", {id: rows[0].xt_juese_zj}, "请确认删除操作", function () {
...
function updateRow() {
    ...
    easyuiLoadWindowByURL('showUpdatePage', '修改', '/xt/xtjuese2/update/select.jw?id=' + rows[0].xt_juese_zj);
}
...
function seeRow() {
    ...
    easyuiLoadWindowByURL('showSeeOnePage', '明细', '/xt/xtjuese2/select/selectOne.jw?id=' + rows[0].xt_juese_zj);
}
...
function update01() {//审核
    ...
    easyuiAjax("/xt/xtjuese2/update/examine.jw", {ids: easyuiGetRowsID(rows, 'xt_juese_zj')}, "请确认审核操作", function () {
        easyuiTreeGridReload('dg')
    });
}
function update10() {//反审核
    ...
    easyuiAjax("/xt/xtjuese2/update/unexamine.jw", {ids: easyuiGetRowsID(rows, 'xt_juese_zj')}, "请确认反审核操作", function () {
        easyuiTreeGridReload('dg')
    });
}
function update04() {//作废
    ...
    easyuiAjax("/xt/xtjuese2/update/void.jw", {ids: easyuiGetRowsID(rows, 'xt_juese_zj')}, "请确认作废操作", function () {
        easyuiTreeGridReload('dg')
    });
}
function update40() {//反作废
    ...
    easyuiAjax("/xt/xtjuese2/update/unvoid.jw", {ids: easyuiGetRowsID(rows, 'xt_juese_zj')}, "请确认反作废操作", function () {
        easyuiTreeGridReload('dg')
    });
}
//-------------------------子页面调用方法-------------------------                
