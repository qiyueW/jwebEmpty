...
//需要初始化的，统一放到此函数来
function inidoAdd() {
    toCreateTree("divID_Tree_menu_XtJuese", "xt_juese_zj", "xt_juese_fzj", "xt_juese_mc", "/xt/xtjuese3/select/json.jw", false, function (event, id, treeNode) {
...
function submitForm(formid) {
    var vcheck = $('#'+formid).form('enableValidation').form('validate');
            if (vcheck) {
                ...
                easyuiAjax("/xt/xtjuese3/save.jw", data, "请确认保存操作", function () {
