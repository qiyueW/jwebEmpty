...
//初始化
function inido() {
    toCreateTree("divID_Tree_menu_XtJuese", "xt_juese_zj", "xt_juese_fzj", "xt_juese_mc", "/xt/xtjuese2/select/json.jw", false,onclickdo,true);
...
function submitForm(formid) {
    var vcheck = $('#'+formid).form('enableValidation').form('validate');
            if (vcheck) {
                ...
                easyuiAjax("/xt/xtjuese2/update.jw", data, "请确认修改操作", function () {
