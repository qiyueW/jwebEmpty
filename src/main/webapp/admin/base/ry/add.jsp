...
-->
        <div data-options="region:'center'" id='centerMain'>
                    <input type="hidden" id="ry_zj" name="ry_zj" value="">
                    <input type="hidden" id="ry_bm_zj" name="ry_bm_zj" value="">
                    <input type="hidden" id="ry_gangwei_zj" name="ry_gangwei_zj" value="">
                    <input type="hidden" id="ry_zhiwei_zj" name="ry_zhiwei_zj" value="">
                    <input type="hidden" id="ry_zhidanren_zj" name="ry_zhidanren_zj" value="">

<div class="container"  id="RYFormID">
                <div class="row-fluid">
                    <div class="span12">
                        <a href="javascript:void(0)" class="btn btn-default btn-large" onclick="clearForm()">清空</a>
                        <a href="javascript:void(0)" class="btn btn-primary btn-large" onclick="submitForm('RYFormID')">保存</a>
                    </div>
                </div>
                 <div class="row-fluid">
                    <div class="span12">
                        <span class="myname" >部门</span>
                        <input type="text"  id="ry_bm" name="ry_bm" data-options="required:true" class="easyui-textbox"/>
                    </div>
                </div>
                 <div class="row-fluid">
                    <div class="span12">
                 ...
                 <div class="row-fluid">
                    <div class="span12">
                        ...
                        <input type="text"  id="ry_gangwei" name="ry_gangwei" data-options="required:false" class="easyui-textbox"/>
                    </div>
                </div>
                 <div class="row-fluid">
                    <div class="span12">
                 ...
                 <div class="row-fluid">
                    <div class="span12">
                        ...
                        <input type="text"  id="ry_zhidanren" name="ry_zhidanren" data-options="required:true" class="easyui-textbox"/>
                    </div>
                </div>
                 <div class="row-fluid">
                    <div class="span12">
                        <span class="myname" >隔离标识</span>
                        <input type="text"  id="ry_gelibiaoshi" name="ry_gelibiaoshi" data-options="required:true" class="easyui-textbox"/>
                    </div>
                </div>
            </div>
        </div>
