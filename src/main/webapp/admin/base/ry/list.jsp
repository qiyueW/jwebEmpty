...
<html>
    ...
    <body class="easyui-layout">
        <table id="dg" class="easyui-datagrid" fit='true'
            ...
            <thead>
                <tr>
                    <th data-options="field:'ck',checkbox:true"></th>                    <th data-options="field:'ry_zj'">主键</th>
                       <th data-options="field:'ry_bm',width:90"><div>部门</div></th>
                    ...
                    <th data-options="field:'ry_ruzhiriqi',width:130"><div>入职日期</div></th>
                    <th data-options="field:'ry_chushengriqi',width:130"><div>出生日期</div></th>
                    <th data-options="field:'ry_lizhiriqi',width:130"><div>离职日期</div></th>
                    ...
                    <th data-options="field:'ry_gangwei_zj'">岗位主键</th>
                       <th data-options="field:'ry_gangwei',width:90"><div>岗位</div></th>
                    <th data-options="field:'ry_zhiwei_zj'">职位主键</th>
                       <th data-options="field:'ry_zhiwei',width:90"><div>职位</div></th>
                    <th data-options="field:'ry_tupian',width:60,formatter:f_grid_file"><div>图片</div></th>
