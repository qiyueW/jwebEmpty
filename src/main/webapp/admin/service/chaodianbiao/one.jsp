                    ...
                    <table border="1" cellpadding="0" cellspacing="0" bordercolor="#0000CC">
                        ...
                        <tr height="32">
                            ...
                            <td bordercolor="#9900FF">
                                <input type="text" readonly id="chaodianbiao_riqi2"/>
                            </td>
                            <td align="right" valign="middle" bordercolor="#9900FF" bgcolor="#CCCCFF"><span class="STYLE2">上次抄表日期</span></td>
                            <td bordercolor="#9900FF">
                                <input type="text" readonly id="chaodianbiao_riqi1"/>
                            </td>
                        </tr>                        
                        <tr height="32">
                            <td height="32" align="right" valign="middle" bordercolor="#9900FF" bgcolor="#CCCCFF"><span class="STYLE2">本次读数</span></td>
                            <td bordercolor="#9900FF"><input type="text" readonly id="chaodianbiao_dushu2" data-options="required:true" value="${ChaoDianbiao.chaodianbiao_dushu2}"class="easyui-textbox"/></td>
