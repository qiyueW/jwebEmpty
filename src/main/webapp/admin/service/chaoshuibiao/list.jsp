        ...
        <table id="dg" class="easyui-datagrid" fit='true'
            ...
            <thead>
                <tr>
                    ...
                    <th data-options="field:'chaoshuibiao_riqi2',width:80"><div>抄表日期</div></th>
                     <th data-options="field:'chaoshuibiao_riqi1',width:80"><div>上次抄表日期</div></th>
                    ...
                    <th data-options="field:'chaoshuibiao_shui',width:60"><div>水(吨)</div></th>
                    ...
                    <th data-options="field:'chaoshuibiao_fentanrenshu',width:60"><div>分摊人数</div></th>
                    <th data-options="field:'chaoshuibiao_yj_fentanrenshu',width:60"><div>已纳费人数</div></th>
